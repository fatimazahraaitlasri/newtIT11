 ...
 */
final class Version20231207083021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD no_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526C1A65C546 ON comment');
        $this->addSql('ALTER TABLE comment DROP no_id');
    }
}
